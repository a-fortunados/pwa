let peliculas = {
  ...
  spiderman: {
    nombre: 'Spiderman',
    src: './images/ciencia-ficcion/spiderman-p.jpg',
    sinopsis:
  ...
  moonfall: {
    nombre: 'Moonfall',
    src: './images/ciencia-ficcion/moonfall-p.jpg',
    sinopsis:
  ...
  jurassicisland: {
    ...
    sinopsis:
      'Ava descubre el paradero de su padre desaparecido en una isla desconocida; un mítico mundo perdido descubierto ante ellos por su abuelo. Junto a un grupo de aventureros y científicos, llegan a Jurassic Island, donde queda claro que el equipo anterior se había topado con un desastre. Los dinosaurios y las sanguijuelas tóxicas significan que ya no es una búsqueda de su padre, sino una batalla por la supervivencia.',
  },
  lastsurvivors: {
    nombre: 'Last Survivors',
    src: './images/ciencia-ficcion/last-survivors-p.jpg',
    sinopsis:
      'Un hombre intenta criar a su hijo en el salvajismo de un mundo postapocalíptico. Sin embargo, el joven desafía a su padre y comienza una relación con una misteriosa mujer.',
  },
  matrix: {
    nombre: 'Matrix',
    src: './images/ciencia-ficcion/matrix-p.jpg',
    sinopsis:
      'Thomas Anderson lleva una vida cómoda como una eminencia dentro del mundo de los videojuegos, pero tiene problemas para discernir entre lo que es realidad y lo que no lo es. Thomas deberá decidir si sigue al conejo blanco una vez más.',
  },
  projectgemini: {
  ...
  theprototype: {
    ...
    sinopsis:
      'Un humanoide robotizado consigue escapar del control de sus creadores, el gobierno de Estados Unidos. Comenzará entonces una difícil misión en la que tratarán de capturarlo, aunque será difícil ya que el robot ha sido precisamente especializado en ese tipo de situaciones.',
  },
};
